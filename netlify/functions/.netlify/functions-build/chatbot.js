...
const handler = async (event) => {
    ...
    try {
        ...
        const financialData = {
            incomes: incomes || [], // Use an empty array if incomes is null
            expenditures: expenditures || [], // Use an empty array if expenditures is null
            assets: assets || [], // Use an empty array if assets is null
            liabilities: liabilities || [], // Use an empty array if liabilities is null
